...
public class TercerPatron {
	...
	public static void main(String[] args) {
		...
		while (veces <= 30) {
			celActual = Main.contarCel(faro); //Método contar células
			// Imprimir información
			System.out.println("GENERACIÓN: " + veces);
			Main.visualizar(faro); //Método visualizar el tablero.
			System.out.println();
			// Método para vivir o morir.
			Main.supervivencia(faro);
			veces++;
		}
		//Muestra información de las que quedan vivas.
