...
//	Enlazada Simple funciona correctamente. (1,5 puntos)
	...
	@Test
	public void Insert_Nodo_Lista_Vacia() {
	...
	@Test
	public void Insert_Nodo_AlFinal() {
		//creamos lista
		ListaEnlazadaSimple lista = new ListaEnlazadaSimple();
		//creamos nodos
...
//	Lista Enlazada Simple funciona correctamente. (1,5 puntos)
	...
	@Test
	public void Delete_Nodo_Lista_Vacia() {
		//creamos lista
		ListaEnlazadaSimple lista = new ListaEnlazadaSimple();
		//añadimos nodos
		lista.eliminar(1);
	...
	@Test
	public void Delete_Nodo_Lista_Principio() {
		//creamos lista
		ListaEnlazadaSimple lista = new ListaEnlazadaSimple();
		//añadimos nodos
		//creamos nodos
	...
	@Test
	public void Delete_Nodo_Lista_Final() {
		//creamos lista
		ListaEnlazadaSimple lista = new ListaEnlazadaSimple();
		//añadimos nodos
		//creamos nodos
	...
	@Test
	public void Delete_Nodo_Lista_Medio() {
		//creamos lista
		ListaEnlazadaSimple lista = new ListaEnlazadaSimple();
		//añadimos nodos
		//creamos nodos
...
//	Enlazada Simple funciona correctamente. (2 puntos)
	...
	@Test
	public void Buscar_Nodo_Lista_Vacia() {
		//creamos lista
		ListaEnlazadaSimple lista = new ListaEnlazadaSimple();
	...
	@Test
	public void Buscar_Nodo_Lista_Llena_True() {
		ListaEnlazadaSimple lista = new ListaEnlazadaSimple();
		//añadimos nodos
		//creamos nodos
		Nodo n3 = new Nodo(3, null);
	...
	@Test
	public void Buscar_Nodo_Lista_Llena_False() {
		ListaEnlazadaSimple lista = new ListaEnlazadaSimple();
		//añadimos nodos
		//creamos nodos
		Nodo n3 = new Nodo(3, null);
