...
public class UsuarioBizi implements Comparable{
	...
	/**
	 * Método que suma +1 a los traslados.
	 */
	...
	/**
	 * Método que suma +1 a los circulares.
	 */
	...
	public String toString(){
		return "Usuario: " + idUsuario + " Traslados: " + usosTraslados + " Circulares: " + usosCirculares + " Total: " + (usosTraslados + usosCirculares);
	}
	...
	public int compareTo(Object miObjeto) {
		...
		if((this.usosCirculares + this.usosTraslados) < (nuevo.usosCirculares + nuevo.usosTraslados)) {
			return 1;
		}
		if((this.usosCirculares + this.usosTraslados) > (nuevo.usosCirculares + nuevo.usosTraslados)) {
			return -1;
